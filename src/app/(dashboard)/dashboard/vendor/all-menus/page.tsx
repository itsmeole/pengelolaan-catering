...
export default function VendorAllMenusPage() {
  ...
  if (loading) return <div className="p-8">Loading menu publik...</div>
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-3xl font-bold tracking-tight text-primary">Menu Mingguan (Publik)</h2>
        <p className="text-muted-foreground">Lihat seluruh menu dari semua vendor untuk mengantisipasi kesamaan menu.</p>
      </div>
